...
--synthesis_resources = 
 ...
 ENTITY  can_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END can_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF can_mm_interconnect_0_cmd_xbar_demux IS
 ...
 END RTL; --can_mm_interconnect_0_cmd_xbar_demux
