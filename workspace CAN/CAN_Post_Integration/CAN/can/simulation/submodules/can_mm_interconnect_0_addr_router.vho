...
--synthesis_resources = 
 ...
 ENTITY  can_mm_interconnect_0_addr_router IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END can_mm_interconnect_0_addr_router;

 ARCHITECTURE RTL OF can_mm_interconnect_0_addr_router IS
	 ...
	 SIGNAL  s_wire_can_mm_interconnect_0_addr_router_src_channel_1_237_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	wire_w221w(0) <= NOT s_wire_can_mm_interconnect_0_addr_router_src_channel_1_237_dataout;
	wire_w_lg_w_sink_data_range145w266w(0) <= NOT wire_w_sink_data_range145w(0);
	s_wire_can_mm_interconnect_0_addr_router_src_channel_1_237_dataout <= (wire_w_lg_w_sink_data_range142w267w(0) AND sink_data(49));
	sink_ready <= src_ready;
	src_channel <= ( "0" & wire_w221w & s_wire_can_mm_interconnect_0_addr_router_src_channel_1_237_dataout);
	src_data <= ( sink_data(87 DOWNTO 75) & wire_w221w & s_wire_can_mm_interconnect_0_addr_router_src_channel_1_237_dataout & sink_data(72 DOWNTO 0));
 ...
 END RTL; --can_mm_interconnect_0_addr_router
