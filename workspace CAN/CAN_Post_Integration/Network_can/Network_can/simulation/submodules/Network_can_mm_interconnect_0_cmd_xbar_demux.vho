...
--synthesis_resources = 
 ...
 ENTITY  Network_can_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END Network_can_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF Network_can_mm_interconnect_0_cmd_xbar_demux IS
 ...
 END RTL; --Network_can_mm_interconnect_0_cmd_xbar_demux
