...
--synthesis_resources = 
 ...
 ENTITY  Network_can_mm_interconnect_0_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END Network_can_mm_interconnect_0_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF Network_can_mm_interconnect_0_cmd_xbar_demux_001 IS
 ...
 END RTL; --Network_can_mm_interconnect_0_cmd_xbar_demux_001
