-- network_can_mm_interconnect_1_width_adapter_002.vhd
...
entity network_can_mm_interconnect_1_width_adapter_002 is
	generic (
		...
		OUT_PKT_ORI_BURST_SIZE_L      : integer := 67;
		OUT_PKT_ORI_BURST_SIZE_H      : integer := 69;
...
end entity network_can_mm_interconnect_1_width_adapter_002;

architecture rtl of network_can_mm_interconnect_1_width_adapter_002 is
...
begin
	...
	out_pkt_ori_burst_size_l_check : if OUT_PKT_ORI_BURST_SIZE_L /= 67 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_h_check : if OUT_PKT_ORI_BURST_SIZE_H /= 69 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
...
end architecture rtl; -- of network_can_mm_interconnect_1_width_adapter_002
