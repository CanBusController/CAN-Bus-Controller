add wave -noupdate -divider {Network_can_nios2_qsys_1: top-level ports}
...
add wave -noupdate -divider {Network_can_nios2_qsys_1: common}
...
add wave -noupdate -divider {Network_can_nios2_qsys_1: breaks}
