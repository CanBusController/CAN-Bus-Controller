-- network_can_mm_interconnect_1_width_adapter.vhd
...
entity network_can_mm_interconnect_1_width_adapter is
	generic (
		...
		IN_PKT_ORI_BURST_SIZE_L       : integer := 67;
		IN_PKT_ORI_BURST_SIZE_H       : integer := 69;
...
end entity network_can_mm_interconnect_1_width_adapter;

architecture rtl of network_can_mm_interconnect_1_width_adapter is
...
begin
	...
	in_pkt_ori_burst_size_l_check : if IN_PKT_ORI_BURST_SIZE_L /= 67 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	in_pkt_ori_burst_size_h_check : if IN_PKT_ORI_BURST_SIZE_H /= 69 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
...
end architecture rtl; -- of network_can_mm_interconnect_1_width_adapter
