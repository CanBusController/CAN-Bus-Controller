add wave -noupdate -divider {Network_can_nios2_qsys_0: top-level ports}
...
add wave -noupdate -divider {Network_can_nios2_qsys_0: common}
...
add wave -noupdate -divider {Network_can_nios2_qsys_0: breaks}
