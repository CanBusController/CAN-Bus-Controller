...
--synthesis_resources = 
 ...
 ENTITY  CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_demux;

 ARCHITECTURE RTL OF CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_demux IS
 ...
 END RTL; --CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_demux
