-- can_controller_mm_interconnect_0_width_adapter_001.vhd
...
entity can_controller_mm_interconnect_0_width_adapter_001 is
	generic (
		...
		OUT_PKT_RESPONSE_STATUS_H     : integer := 57;
		OUT_PKT_RESPONSE_STATUS_L     : integer := 56;
		OUT_PKT_TRANS_EXCLUSIVE       : integer := 28;
		OUT_PKT_BURST_TYPE_H          : integer := 39;
		OUT_PKT_BURST_TYPE_L          : integer := 38;
		OUT_PKT_ORI_BURST_SIZE_L      : integer := 58;
		OUT_PKT_ORI_BURST_SIZE_H      : integer := 60;
		OUT_ST_DATA_W                 : integer := 61;
...
end entity can_controller_mm_interconnect_0_width_adapter_001;

architecture rtl of can_controller_mm_interconnect_0_width_adapter_001 is
...
begin
	...
	out_pkt_ori_burst_size_l_check : if OUT_PKT_ORI_BURST_SIZE_L /= 58 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	out_pkt_ori_burst_size_h_check : if OUT_PKT_ORI_BURST_SIZE_H /= 60 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
...
end architecture rtl; -- of can_controller_mm_interconnect_0_width_adapter_001
