-- can_controller_mm_interconnect_0_width_adapter.vhd
...
entity can_controller_mm_interconnect_0_width_adapter is
	generic (
		...
		IN_PKT_RESPONSE_STATUS_H      : integer := 57;
		IN_PKT_RESPONSE_STATUS_L      : integer := 56;
		IN_PKT_TRANS_EXCLUSIVE        : integer := 28;
		IN_PKT_BURST_TYPE_H           : integer := 39;
		IN_PKT_BURST_TYPE_L           : integer := 38;
		IN_PKT_ORI_BURST_SIZE_L       : integer := 58;
		IN_PKT_ORI_BURST_SIZE_H       : integer := 60;
		IN_ST_DATA_W                  : integer := 61;
	...
	port (
		...
		in_data              : in  std_logic_vector(60 downto 0) := (others => '0'); --          .data
...
end entity can_controller_mm_interconnect_0_width_adapter;

architecture rtl of can_controller_mm_interconnect_0_width_adapter is
...
begin
	...
	in_pkt_ori_burst_size_l_check : if IN_PKT_ORI_BURST_SIZE_L /= 58 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;

	in_pkt_ori_burst_size_h_check : if IN_PKT_ORI_BURST_SIZE_H /= 60 generate
		assert false report "Supplied generics do not match expected generics" severity Failure;
	end generate;
...
end architecture rtl; -- of can_controller_mm_interconnect_0_width_adapter
