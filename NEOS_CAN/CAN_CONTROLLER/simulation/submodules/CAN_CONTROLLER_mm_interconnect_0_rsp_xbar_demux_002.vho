...
--synthesis_resources = 
 ...
 ENTITY  CAN_CONTROLLER_mm_interconnect_0_rsp_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END CAN_CONTROLLER_mm_interconnect_0_rsp_xbar_demux_002;

 ARCHITECTURE RTL OF CAN_CONTROLLER_mm_interconnect_0_rsp_xbar_demux_002 IS
 ...
 END RTL; --CAN_CONTROLLER_mm_interconnect_0_rsp_xbar_demux_002
