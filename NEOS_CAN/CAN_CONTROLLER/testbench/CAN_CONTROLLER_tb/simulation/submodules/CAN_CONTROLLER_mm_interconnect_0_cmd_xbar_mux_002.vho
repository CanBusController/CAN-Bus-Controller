...
--synthesis_resources = 
 ...
 ENTITY  CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_mux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_mux_002;

 ARCHITECTURE RTL OF CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_mux_002 IS
 ...
 BEGIN
	...
	src_channel <= ( sink0_channel(2 DOWNTO 0));
 ...
 END RTL; --CAN_CONTROLLER_mm_interconnect_0_cmd_xbar_mux_002
